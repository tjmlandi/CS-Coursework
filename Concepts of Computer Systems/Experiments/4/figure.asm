...
block_area:
	...
	lw	$t0, 4($a0)			#load the width
	lw	$t1, 8($a0)			#load the height

	mul	$v0, $t0, $t1			#multiply the width and height
...
block_perimeter:
	...
	lw	$t0, 4($a0)			#load the height and width
	lw	$t1, 8($a0)

	add	$t0, $t0, $t0			#double the height and width
	add	$t1, $t1, $t1

	add	$v0, $t0, $t1			#add the doubled height and width
