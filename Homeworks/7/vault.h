// 
// $Id: vault.h,v 2.1 2014/11/13 02:45:57 csci243 Exp $ 
// File: vault.h 
...
/// file size, and record index, and returns a vault identifier.
/// The initial index is set to 0, the index of the start of the file.
/// Uses fstat to determine file size.
/// If a vault file is curently open, of if the open of the specified file
/// fails, v_open returns an error indication.
/// If the open fails, reports the error using the perror() function.
///
